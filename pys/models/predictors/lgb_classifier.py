...
def run_lgb_all_models():
    ...
    for filename in os.listdir(data_dir):
        if "reduced" in filename and "אחוזון" in filename:
            ...
            dataset_name = "LightGBMClassifier" + os.path.splitext(filename)[0]
            ...
            best_model, x_val_selected, y_val = model_with_fs_optimized(df_to_train, lgb.LGBMClassifier(
                                                                        random_state=42,
                                                                        verbose=-1),
                                                                        "LightGBMClassifier_", results_dir,
